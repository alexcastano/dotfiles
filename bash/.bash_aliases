...
alias ver-scr='xrandr --output HDMI1 --mode 1920x1200 --pos 0x0 --rotate left --output LVDS1 --mode 1366x768 --pos 1200x780'
alias hor-scr='xrandr --output HDMI1 --mode 1920x1200 --pos 0x0 --rotate normal --output LVDS1 --mode 1366x768 --pos 1920x432'
